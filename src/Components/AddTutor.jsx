      ...
      render() {
        if (this.state.show) document.title = "Price Watch | Add Product";
          ...
          return (
            ...
            <Button variant='contained' style={{marginTop:"0px", borderRadius:'100px', background:'#5185ed', fontFamily:'Avenir, Nunito Sans, sans-serif', fontWeight:'900', textTransform:'none', fontSize:'20px', padding:'0px 25px 0px 25px', color:'white'}} 
