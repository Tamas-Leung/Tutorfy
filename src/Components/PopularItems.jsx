            ...
            <div className="col-lg-10" style={{margin:'auto', marginTop:'4%'}}>
                ...
                <div className="col-lg-6" style={{margin:'auto', paddingLeft:'0px'}}>
                        ...
                        {tutors.map((tutor, index) =>
                            <div className="col-lg-4" style={{textAlign:'center', marginBottom:'30px', cursor:'pointer'}} onClick={()=>{this.props.update(tutor.courseName)}}>
                        ...
                        {subjects.map((subject, index) =>
                            <div className="col-lg-4" style={{textAlign:'center', marginBottom:'30px', cursor:'pointer'}} onClick={(input)=>{this.setState({input}); this.props.update(subject.subject)}}>
                                <div style={{height:'250px'}}>
