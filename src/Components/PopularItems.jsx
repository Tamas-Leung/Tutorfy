...
export class PopularItems extends Component {
    render() {
        ...
        return (
            <div className="col-lg-10" style={{margin:'auto', marginTop:'4%', marginBottom:'3%'}}>
                <div className="row" >
                <div className="col-lg-6" style={{margin:'auto', paddingLeft:'0px', paddingRight:'30px'}}>
                        ...
                        {tutors.map((tutor, index) =>
                            <div className="col-lg-4" style={{textAlign:'center',  cursor:'pointer', padding:'10px'}} onClick={()=>{this.props.update(tutor.courseName)}}>
                        ...
                        {subjects.map((subject, index) =>
                            <div className="col-lg-4" style={{textAlign:'center',  cursor:'pointer', padding:'10px'}} onClick={(input)=>{this.setState({input}); this.props.update(subject.subject)}}>
                                <div style={{height:'250px'}}>
